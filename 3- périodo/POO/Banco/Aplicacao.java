...
*/
       // System.out.println("Saldo: " + cRicardo.emitirSaldo());
        ...
        //System.out.println(cPedro.transferir(cRicardo, 800.0) ? "Transferencia Realizada" : "Saldo Insuficiente");
        //System.out.println("Saldo: " + cPedro.emitirSaldo());
        //System.out.println("Saldo: " + cRicardo.emitirSaldo());
        cPedro.sacar(800.0);
